...
<head>
  ...
  <title>Analasis de sistemas</title>
    ...
    <div class="topbar d-flex align-items-center">
      <div class="container d-flex justify-content-center justify-content-md-between">
        <div class="contact-info d-flex align-items-center">
          <i class="bi bi-envelope d-flex align-items-center"><a href="mailto:contact@example.com">sistema@sismedical.com</a></i>
          <i class="bi bi-phone d-flex align-items-center ms-4"><span>+502 5589 55488 </span></i>
        </div>
        ...
        <div class="content row gy-4">
          <div class="col-lg-4 d-flex align-items-stretch">
            <div class="why-box" data-aos="zoom-out" data-aos-delay="200">
              <h3>Reservar tu cita</h3>
              <p>
                Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Duis aute irure dolor in reprehenderit
                Asperiores dolores sed et. Tenetur quia eos. Autem tempore quibusdam vel necessitatibus optio ad corporis.
              </p>
              <div class="text-center">
                <a href="{{url('/admin')}}" class="more-btn"><span>agendar</span> <i class="bi bi-chevron-right"></i></a>
              </div>
            </div>
          </div><!-- End Why Box -->
            ...
            <div class="card-body">
              <script>
                $('#consultorio_select').on('change', function() {
                  ...
                  if (consultorio_id) {
                    $.ajax({
                      url: "{{url('/consultorios')}}" + '/' + consultorio_id, //o url comentada
                      type: 'GET',
  ...
  <div class="modal-dialog modal-sm">
    <div class="modal-content">
      <div class="modal-header">
        <h5 class="modal-title" id="chatModalLabel">chat sismedical</h5>
...
<style>
  ...
  .chat-bubble a {
    color: #ffffff; /* Cambia el color del texto del enlace al blanco */
    text-decoration: underline; /* Añadir subrayado para que se note más */
}
.chat-bubble a:hover {
    color: #f1f1f1; /* Cambia ligeramente el color cuando pases el mouse por encima */
    text-decoration: underline; /* Asegura que el subrayado permanezca al pasar el mouse */
}
...
<script>
  ...
  function addMessageToChatbox(sender, message) {
    ...
    const bubbleElement = document.createElement('div');
    bubbleElement.classList.add('chat-bubble');
    bubbleElement.innerHTML = message;  // Cambiado a innerHTML
