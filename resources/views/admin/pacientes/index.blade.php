                ...
                <table id="example1" class="table table-striped table-bordered table-hover  table-sm">
                    <thead class="thead-dark">
                        <tr>
                            ...
                            <th scope="col" style="text-align: center">Nro Seguro</th>
                            ...
                            <th scope="col" style="text-align: center">Direecion</th>
                    ...
                    <tbody class="">
                        @foreach($pacientes as $paciente)                       
                            <tr> 
                                ...
                                <td style="text-align: center">{{$paciente->dpi }}</td>
                                <td style="text-align: center">{{$paciente->numero_seguro}}</td>
                                ...
                                <div class="btn-group" role="group" aria-label="Basic example">
                                    <a href="{{url('admin/pacientes/'.$paciente->id)}}" type="button" class="btn btn-info btn-sm"><i class="bi bi-eye">Ver</i></a>
                                    <a href="{{url('admin/pacientes/'.$paciente->id.'/edit')}}" type="button" class="btn btn-success btn-sm"><i class="bi bi-pencil"></i>Editar</a>
                                    <a href="{{url('admin/pacientes/'.$paciente->id.'/confirm-delete')}}" type="button" class="btn btn-danger btn-sm"><i class="bi bi-trash3"></i>Borrar</a>
                                </div>
                                </td>       
                            </tr>
                        @endforeach
